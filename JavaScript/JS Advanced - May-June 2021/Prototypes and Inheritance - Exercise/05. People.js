function company() {
    class Employee {
        ...
        _calculateSalary() { return this.salary; }
    ...
    class Junior extends Employee {
        constructor(name, age) { super(name, age, ['{name} is working on a simple task.']); }
    }
    ...
    class Manager extends Employee {
        ...
        _calculateSalary() { return this.salary + this.dividend; }
    }
