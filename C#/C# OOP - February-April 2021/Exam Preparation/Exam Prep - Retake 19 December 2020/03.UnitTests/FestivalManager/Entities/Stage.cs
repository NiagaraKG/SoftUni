namespace FestivalManager.Entities
{
    ...
    public class Stage
    {
        ...
        public void AddPerformer(Performer performer)
        {
            ...
            if (performer.Age < 18) { throw new ArgumentException("You can only add performers that are at least 18."); }
        ...
        public void AddSong(Song song)
        {
            ...
            if (song.Duration.TotalMinutes < 1) { throw new ArgumentException("You can only add songs that are longer than 1 minute."); }
            this.Songs.Add(song);
        }
        ...
        private Performer GetPerformer(string performerName)
        {
            ...
            if (performer == null) { throw new ArgumentException("There is no performer with this name."); }
            return performer;
        }
        ...
        private Song GetSong(string songName)
        {
            ...
            if (song == null) { throw new ArgumentException("There is no song with this name."); }
            return song;
        }

        private void ValidateNullValue(object variable, string variableName, string exceptionMessage)
        {
            if (variable == null) { throw new ArgumentNullException(variableName, exceptionMessage); }
        }
    }
}
