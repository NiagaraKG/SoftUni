...
namespace FightingArena
{
    public class Arena
    {
        ...
        public Arena() { this.warriors = new List<Warrior>(); }
        ...
        {
            if (this.warriors.Any(w => w.Name == warrior.Name)) { throw new InvalidOperationException("Warrior is already enrolled for the fights!"); }
        ...
        public void Fight(string attackerName, string defenderName)
        {
            ...
            if (attacker == null || defender == null)
            {
                ...
                if (defender == null) { missingName = defenderName; }
